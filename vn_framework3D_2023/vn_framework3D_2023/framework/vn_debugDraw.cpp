...
{
	//横線
	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 0.0f;          vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 0.0f;          vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval;      vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval;      vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval;       vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x =  5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval;       vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 2;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 2;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval * 2;   vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval * 2;   vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 3;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 3;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval * 3;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval * 3;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 4;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 4;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval * 4;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = interval * 4;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -5.0f;         vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 5;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 5.0f;          vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = -interval * 5;  vtx[VertexNum].color = color;   VertexNum++;
	...
	//縦線
	vtx[VertexNum].x = 0.0f;          vtx[VertexNum].y = 0.0f;   vtx[VertexNum].z = -5.0f;         vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = 0.0f;          vtx[VertexNum].y = 0.0f;   vtx[VertexNum].z =  5.0f;         vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -interval;      vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;       vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = -interval;      vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z =  5.0f;       vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = interval;       vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;       vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = interval;       vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z =  5.0f;       vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -interval * 2;    vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = -interval * 2;    vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = interval * 2;   vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = interval * 2;   vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -interval * 3;    vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = -interval * 3;    vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = interval * 3;   vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = interval * 3;   vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -interval * 4;    vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = -interval * 4;    vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;  vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = interval * 4;   vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = interval * 4;   vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;    vtx[VertexNum].color = color;   VertexNum++;

	vtx[VertexNum].x = -interval * 5;    vtx[VertexNum].y = 0.0f;  vtx[VertexNum].z = -5.0f;  vtx[VertexNum].color = color;   VertexNum++;
	vtx[VertexNum].x = -interval * 5;    vtx[VertexNum].y = 0.0f; vtx[VertexNum].z = 5.0f;  vtx[VertexNum].color = color;   VertexNum++;
